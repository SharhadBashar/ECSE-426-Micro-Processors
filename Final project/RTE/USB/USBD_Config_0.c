...
#define USBD0_STR_DESC_MAN              L"ECSE426 Mouse"

//     <s.126>Product String
//     <i>String Descriptor describing Product.
#define USBD0_STR_DESC_PROD             L"GXX_Mouse"
